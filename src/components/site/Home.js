    ...
    return(
        <div className='main'>
            <div className='mainDiv'>
                ...
                <p>
                    This app is intended to be a starter / tutorial  app for your upcoming project and a learning sandbox for you in months and years to come should you continue to develop software with React concepts, build out some small applications, and then unleashe you to build your own applications.
                </p>
                <hr/>
                <h1> Important Notes </h1>
                <ul>
                    <li>Being component based, you can move on to the next module</li>
                    <li>The styling is intentionally left blad in some spots </li>

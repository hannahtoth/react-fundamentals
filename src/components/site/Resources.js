const Resources = () => {
    return (
        <div className="main">
            ...
            <p>Below are some of the resources that we used throughout this app.
            ...
            <ul>
                ...
                <li>
                    <a href="https://www.udemy.com/course/react-the-guide-incl-redux" traget="_blank">
                        Maximilan Schwarzmuller's Udemy Course
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="https://github.com/bmorelli25/interactive-bitcoin-in-price-chart" target="_blank">
                        Bitcoin
                    </a>
                </li>
                <li> 
